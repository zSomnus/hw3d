	...
	phi(adist(rng))
{
	if (!IsStaticInitialized())
	{
		...
		model.vertices[0].color = { 255,255,0,1 };
		model.vertices[1].color = { 255,255,0,1 };
		model.vertices[2].color = { 255,255,0,1 };
		model.vertices[3].color = { 255,255,0,1 };
		model.vertices[4].color = { 255,255,80,1 };
		model.vertices[5].color = { 255,10,0,1 };
