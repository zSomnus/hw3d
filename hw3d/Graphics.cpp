...
Graphics::Graphics(HWND hWnd)
{
	...
	// For checking results of D3D funcitons
	HRESULT hr;
	...
	// Width and height here should mathc those of the swap chain
...
void Graphics::DrawTestTriangle(float angle, float x, float y)
{
	...
	/** Creating as dynamic allow the use of the Lock function.
		It's also possible to update with UpdateSubresource on
		a non-dynamic.
	*/
